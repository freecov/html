...
<div class="breadcrumb-covide">
	...
	<a class="current" href="projects_activities_groups.php">Manage Activities Groups</a>
</div>
	...
	<div class="span9">
        ...
        <div class="well well-covide">
            <div class="well-title">
                <span class="title">Manage Activities Groups</span>
            </div>
			...
			<div class="well-title">
                <span class="title">Add New Activity Group</span>
            </div>
				...
				<table class="table table-condensed table-striped table-hover table-activities">
					...
					<tbody>
						<tr>
							<td><input class="span12" type="text" value="" placeholder="Group Name"></td>
							<td>
