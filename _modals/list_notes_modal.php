<div class="row-fluid">
	<div class="well well-covide">
			...
			<a class="btn btn-warning" data-toggle="modal" href="_modals/add_note_modal.php" data-target="#addnote_lnm_Modal">Add Note</a>
			<!-- Start Add Note Modal -->
				<div id="addnote_lnm_Modal" class="modal add-relation-modal hide fade text-left" tabindex="-1" role="dialog" aria-labelledby="addnote_lnm_ModalLabel" aria-hidden="true">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-remove-sign"></i></button>
						<h4 id="addnote_lnm_ModalLabel"><i class="icon-pencil"></i> New note</h4>
					</div>
