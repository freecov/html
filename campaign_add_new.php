...
<head>
    <meta charset="utf-8">
    <title>Campaign - Covide CRM</title>
    ...
    <div class="container-fluid">
        ...
        <section class="covide-content">
			<? 
				...
				{
					case 'calling_list': include_once "_content/campaign_new_calling_list.php";break;
					case 'template': include_once "_content/campaign_new_template.php";break; 
					case 'export': include_once "_content/campaign_new_calling_list.php";break;
					//case 'export': include_once "_content/campaign_new_export.php";break;
					default: include_once "_content/campaign_new_calling_list.php";
				};			
			?>
         </section>
